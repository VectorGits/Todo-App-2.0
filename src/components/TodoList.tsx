            ...
            <label className="flex items-center space-x-3 relative">
              <div className="relative flex items-center justify-center w-6 h-6">
                <input
                  ...
                  className="appearance-none rounded-full h-5 w-5 border border-gray-300 focus:outline-none 
                             checked:bg-gradient-to-br checked:from-CheckBlue checked:to-CheckPurple
